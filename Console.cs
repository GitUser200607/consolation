...
namespace Consolation
{
  ...
  class Console : MonoBehaviour
  {
    ...
    public KeyCode toggleKey = KeyCode.BackQuote; // Tilde
    ...
    public bool shakeRequiresTouch = true;
    ...
    /// </summary>
    [Tooltip("Space between the buttons.")]
    public float spacePixels = 10f;

    /// <summary>
    /// Remember Window position.
    /// </summary>
    [Tooltip("Remember Window position.")]
    public bool rememberPos = true;
